...
<div class="container-fluid"> @if(session('message')) <div class="alert alert-success m-3"> {{session('message')}}
        ...
        <tr>
            ...
            <td>
                ...
                <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#ModalUpdatepembelian{{
                    ...
                    data-bs-target="#ModalUpdatepembelian{{ $p->kode_pembelian }}">
                    {{$p->status}}
                </button>
    ...
    str_replace('/','',$p->kode_pembelian) }}">
            ...
            <td>
                ...
                @csrf
                @method('delete')
                <button class=" btn btn-danger" type="submit" data-bs-toggle="modal" data-bs-target="#md{{ str_replace('/','',$p->kode_pembelian) }}">Delete</button>
                </form>
            </td>
            @endif
        </tr>
        ...
        <div class="modal fade" id="md{{ str_replace('/','',$p->kode_pembelian) }}{{$p->kode_pembelian}}" tabindex="-1"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
